...
<header class="py-4">
	<div class="container">
			<div id="logo">
				<h1> <a href="sellerindex.php"><span class="fa fa-home" aria-hidden="true"></span> Online Real Estate</a></h1>
			</div>
		<!-- nav -->
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				...
				<li class="mr-lg-4 mr-3"><a href="viewseller.php">View Profile</a></li>  
				...
				<ul class="inner-ul">
					<li><a href="propertydetails.php">Add Property</a></li>
				...
				<label for="drop-2" class="toggle">Enquiry <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
				<a href="#">Enquiry <span class="fa fa-angle-down" aria-hidden="true"></span></a>
				<input type="checkbox" id="drop-2"/>
				<ul class="inner-ul">
					<li><a href="viewrejectproperty.php">Send Enquiry to admin </a></li>
					<li><a href="viewenquiryreply.php">View Reply</a></li>
				...
				<li class="mr-lg-4"><a href="viewbookedprop.php">Booked Property</a></li>
				<li class="mr-lg-4"><a href="sfeedback.php">Feedback</a></li>
			</ul>
