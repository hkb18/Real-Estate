...
<header class="py-4">
	<div class="container">
			<div id="logo">
				<h1> <a href="index.php"><span class="fa fa-home" aria-hidden="true"></span> Online Real Estate</a></h1>
			</div>
		<!-- nav -->
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				...
				<ul class="inner-ul">
					...
					<li><a href="seller/sellerlogin.php">Seller</a></li>
				<li><a href="buyer/buyerlogin.php">Buyer</a></li>
				</ul>
				</li>
				...
				<label for="drop-2" class="toggle">Search By <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
				<a href="#">Search By <span class="fa fa-angle-down" aria-hidden="true"></span></a>
				<input type="checkbox" id="drop-2"/>
				<ul class="inner-ul">
					<li><a href="buyer/searchname.php">Name</a></li>
					<li><a href="buyer/searchprice.php">Price</a></li>
					<li><a href="buyer/searchptype.php">Property Type</a></li>
				<li><a href="buyer/searchlocation.php">Location</a></li>
					<li><a href="buyer/searchbathroom.php">Bathroom</a></li>
					<li><a href="buyer/searchbedroom.php">Bedroom</a></li>
					<li><a href="buyer/searchta.php">Total Area</a></li>
				</ul>
				</li>	
				
				<li class="mr-lg-4 mr-3"> 
				<!-- Second Tier Drop Down 
				<label for="drop-3" class="toggle">Search Property <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
				<a href="#">Search Property <span class="fa fa-angle-down" aria-hidden="true"></span></a>
				<input type="checkbox" id="drop-3"/>
				<ul class="inner-ul">
					<li><a href="searchproperty.php">Search Property</a></li>
					<li><a href="propertybooking.php">Book Property</a></li>
				...
				<label for="drop-3" class="toggle">Enquiry <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
				<a href="#">Enquiry <span class="fa fa-angle-down" aria-hidden="true"></span></a>
				<input type="checkbox" id="drop-3"/>
				<ul class="inner-ul">
					<li><a href="benquiryqns.php">Send Enquiry to Seller</a></li>
				...
				<li class="mr-lg-4 mr-3"> 
				<!-- Second Tier Drop Down -->
				<label for="drop-3" class="toggle">Manage Property <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
				<a href="#">Manage Property <span class="fa fa-angle-down" aria-hidden="true"></span></a>
				<input type="checkbox" id="drop-3"/>
				<ul class="inner-ul">
					<li><a href="buyer/propertydetails.php">Add Property</a></li>
					<li><a href="buyer/viewproperty.php">View Property</a></li>
				
				</ul>
				</li>

				<li class="mr-lg-4"><a href="buyer/bfeedback.php">Feedback</a></li>
			</ul>
		...
		<!--	<div class="col-lg-4 col-sm-6 footer-grid-wthree">
			...
			<div class="col-lg-2 col-sm-6 footer-grid-wthree mt-lg-0 mt-5">
				...
				<ul class="links list-unstyled">
					<li>
						<h1> <a href="index.php"><span class="fa fa-home" aria-hidden="true"></span>Home</a></h1>
					</li>
				</ul>
			</div>
		</div>
