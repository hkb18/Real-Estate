...
<?php
    ...
    $actions=array(
    'edit'=>array('label'=>'Back','link'=>'viewenquiry.php','params'=>array('id'=>'pid'),'attributes'=>array('class'=>'btn btn-success')),
   ...
   $join=array(
	  ...
	  $fields=array('pid','pname','dname','aname','ptype','ta','bathroom','bedroom','dimensions','price','pdesc','pimage','status');
