           ...
           <!-- /. NAV TOP  --
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li  >
                        <a   href="adminlogin.php"><i class="fa fa-bolt fa-3x"></i> Login</a>
                    </li>	
				
					   <li>
                        <a  href="district.php"><i class="fa fa-desktop fa-3x"></i>Add District</a>
                    </li>
                    <li>
                        <a  href="area.php"><i class="fa fa-dashboard fa-3x"></i>Add Area</a>
                    </li>
                    <li>
                        <a  href="propertytype.php"><i class="fa fa-qrcode fa-3x"></i>Add Property Type</a>
                    </li>
						   <li  >
                        <a  href="viewbuy.php"><i class="fa fa-bar-chart-o fa-3x"></i> Approve Buyer</a>
                    </li>	
                      <li  >
                        <a  href="viewsell.php"><i class="fa fa-table fa-3x"></i> Approve Seller</a>
                    </li>
                    <li  >
                        <a  href="viewprop.php"><i class="fa fa-edit fa-3x"></i> Approve Property </a>
                    </li>			
					 <li  >
                        <a  href="viewarea.php"><i class="fa fa-edit fa-3x"></i> View Area </a>
                    </li>		
					 <li  >
                        <a  href="viewdistrict.php"><i class="fa fa-edit fa-3x"></i> View District </a>
                    </li>		
					 <li  >
                        <a  href="viewpropertytype.php"><i class="fa fa-edit fa-3x"></i> View Property Type </a>
                    </li>	
					 <li  >
                                 <a  href="viewenquiry.php"><i class="fa fa-edit fa-3x"></i>View Enquiry </a>
                    </li>	
					<li  >
                        <a  href="report.php"><i class="fa fa-edit fa-3x"></i> Reports </a>
                    </li>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li  >
					   ...
					   <li>
                        <a  href="adminlogin.php"><i class="fa fa-desktop fa-3x"></i>Add District</a>
                    </li>
                    <li>
                        <a  href="adminlogin.php"><i class="fa fa-dashboard fa-3x"></i>Add Area</a>
                    </li>
                    <li>
                        <a  href="adminlogin.php"><i class="fa fa-qrcode fa-3x"></i>Add Property Type</a>
                    </li>
						   <li  >
                        <a  href="adminlogin.php"><i class="fa fa-bar-chart-o fa-3x"></i> Approve Buyer</a>
                    </li>	
                      <li  >
                        <a  href="adminlogin.php"><i class="fa fa-table fa-3x"></i> Approve Seller</a>
                    </li>
                    <li  >
                        <a  href="adminlogin.php"><i class="fa fa-edit fa-3x"></i> Approve Property </a>
                    </li>			
					 <li  >
                        <a  href="adminlogin.php"><i class="fa fa-edit fa-3x"></i> View Area </a>
                    </li>		
					 <li  >
                        <a  href="adminlogin.php"><i class="fa fa-edit fa-3x"></i> View District </a>
                    </li>		
					 <li  >
                        <a  href="adminlogin.php"><i class="fa fa-edit fa-3x"></i> View Property Type </a>
                    </li>	
					 <li  >
                                 <a  href="adminlogin.php"><i class="fa fa-edit fa-3x"></i>View Enquiry </a>
                    </li>	
					<li  >
                        <a  href="adminlogin.php"><i class="fa fa-edit fa-3x"></i> Reports </a>
                    </li>
	...
	<div class="container py-md-3">
		...
		<div class="row process-grids">
			...
			<div class="col-lg-3 col-md-6 my-lg-4 mt-md-0 mt-4 w3pvt-ab position-relative">
				...
				<h4 class="feed-title my-3">Property For Sale</h4>
			...
			<div class="col-lg-3 col-md-6 mt-lg-4 mt-sm-5 mt-4 w3pvt-ab">
				...
				<h4 class="feed-title my-3">Buy Property</h4>
				<p> Excepteur ut occaecat ipsum proident, sunt int culpa quis. Phasellus lacinia id erat risu quis sunt int dolor.</p>
			</div>
		</div>
	</div>
