    	...
    	<div class="row">
            <div class="col-md-12">
                <table  border="1" class="table" style="margin-top:100px;">
                    <tr>
                       <h3> REPORT OF  PROPERTY NOT BOOKED</h3>
                        <th>PId</th>
                        <th>Property Name</th>
                        <th>District Name</th>
                        <th>Area Name</th>
...
<?php
   ...
   $join=array(
		...
		'proptype as pt'=>array('pt.propid=p.propid','join'),
	  	  ...
	  	  $fields=array('pid','pname','dname','aname','ptype','ta','bathroom','bedroom','dimensions','price','pdesc','pimage','pbstatus');
